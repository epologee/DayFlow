...
@property(nonatomic, readonly, assign) DFLDatePickerDate toDate;
...
- (void)willMoveToSuperview:(UIView *)newSuperview
{
    ...
    if (newSuperview && !_collectionView)
    {
        ...
        NSIndexPath *cellIndexPath = [NSIndexPath indexPathForItem:([cv numberOfItemsInSection:(cv.numberOfSections / 2)] / 2)
                                                         inSection:(cv.numberOfSections / 2)];
...
- (NSInteger)numberOfSectionsInCollectionView:(UICollectionView *)collectionView
{
    ...
    return [self.calendar components:NSMonthCalendarUnit
                            fromDate:[self dateFromPickerDate:self.fromDate]
                              toDate:[self dateFromPickerDate:self.toDate]
                             options:0].month;
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSUInteger weekday = (NSUInteger) [self.calendar components:NSWeekdayCalendarUnit fromDate:firstDayInMonth].weekday;
    ...
    DFLDatePickerDate cellPickerDate = [self pickerDateFromDate:cellDate];
                                 ...
                                 atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader])
    {
        ...
        NSDateFormatter *dateFormatter = [self.calendar dfl_dateFormatterNamed:@"calendarMonthHeader" withConstructor:^{
            ...
            formatter.dateFormat = [formatter.class dateFormatFromTemplate:@"yyyyLLLL" options:0 locale:[NSLocale currentLocale]];
            return formatter;
        }];
...
- (NSDate *)dateFromPickerDate:(DFLDatePickerDate)dateStruct
{
    return [self.calendar dateFromComponents:[self dateComponentsFromPickerDate:dateStruct]];
}

- (NSDateComponents *)dateComponentsFromPickerDate:(DFLDatePickerDate)dateStruct
{
    NSDateComponents *components = [[NSDateComponents alloc] init];
...
- (DFLDatePickerDate)pickerDateFromDate:(NSDate *)date
{
